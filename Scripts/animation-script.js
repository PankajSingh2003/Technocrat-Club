...

{
  ...
  const texts = [
    'Welcome to TechnoCrats Student Club',
    'A club for those who want to do more',
    'With Various Domains and fields',
    "Let's Build Something together which will change the world",
  ];
  let letterCount = 0;
  let index = 0;
  let currentText = '';
